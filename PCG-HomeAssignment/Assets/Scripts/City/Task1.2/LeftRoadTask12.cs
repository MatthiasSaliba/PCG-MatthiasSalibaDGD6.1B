...
public class LeftRoadTask12 : MonoBehaviour
{
    ...
    {
        CreateRoad();
        this.transform.position = new Vector3(-43.05f, 0, 6.9f);
        ...
        for (int i = 0; i < 1; i++)
        {
            ...
            house.name = "leftRoadHouse " + (i + 1);
            house.AddComponent<HouseBuilder>();
            house.GetComponent<HouseBuilder>().setPosition(new Vector3(Random.Range(-51f, -35f), 3f, 11.5f));
        }
    }
