...
public class BottomRoadTask12 : MonoBehaviour
{
    ...
    {
        CreateRoad();
        this.transform.position = new Vector3(-63.85f, 0, 0);
        ...
        for (int i = 0; i < 1; i++)
        {
            ...
            house.name = "bottomRoadHouse " + (i + 1);
            house.AddComponent<HouseBuilder>();
            house.GetComponent<HouseBuilder>().setPosition(new Vector3(-68.44f, 3f, Random.Range(roadLength + i, -roadLength + i)));
        }
    }
